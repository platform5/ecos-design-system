...
export class EcosDesignSystemProvider extends FASTDesignSystemProvider {
  ...
  public connectedCallback(): void {
    ...
    this.registerCSSCustomProperty({
      ...
      value: (system: EcosDesignSystemProvider) => {
        const baseSpacing = system.designUnit * 2; // default designUnit = 4 // Base spacing = 8
        const spacing = Math.pow(2, system.density) * baseSpacing;
